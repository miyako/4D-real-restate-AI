...
// --- Load settings & create client ---
var $sf : 4D.File
$sf:=File("/RESOURCES/settings.json")
If (Not($sf.exists))
	If ($isFrench)
		$highlights:="Paramètres IA introuvables."
	Else 
		$highlights:="AI settings not found."
	End if 
Else 
	var $settings : Object
